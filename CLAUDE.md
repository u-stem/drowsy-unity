...
- **Phase 2**(DrowZzz 本命実装): **進行中**(ADR-0005、M1〜M5)
  ...
  - **M3**(勝利条件 / 終了処理 + ゲームメカニクス拡張): **進行中** — ADR-0010 完成(M3-PR1 完成)、ADR-0011 起票済(M3-PR2 / PR3 / PR4 / PR5a 完成、M3-PR5 を 5a / 5b / 5c に分割、M3-PR5b(Counter 機構)着手中)、M3-PR5c(反撃の反撃)/ PR6(夢統合)順次予定
  - **M4**(永続化 / SO 化): 未着手
