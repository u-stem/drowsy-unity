...
| [0008](0008-m2-drowzzz-clock-and-night-morning.md) | M2 — DrowZzzClock 概念と「夜・朝」フェーズの導入 | Accepted | `DrowZzzClock(int RoundNumber)` 値オブジェクト(Hour / Minute / IsNight / IsMorning)、Session の computed プロパティ経由、真の単一情報源は `TurnNumber`、21:00 開始 / 20 ラウンド / 24 時間制 mod 24、夜 21:00〜04:30 と朝 05:00〜06:30、ラウンド上限到達処理は M3 |
