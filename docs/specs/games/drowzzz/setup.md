...
- [DZ-025] When `Execute(players, initialDeck)` is invoked, the result `TurnPhase` shall be `WaitingForDraw`.
...
| DZ-025 | `Given_有効な引数_When_Execute_Then_TurnPhaseがWaitingForDraw` | |
