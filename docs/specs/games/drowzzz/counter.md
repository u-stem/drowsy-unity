...
| 「反撃の反撃」+ 元カード A の効果遡及発動 | **M3-PR5c で対応済**(`PendingCounteredEffect` record + `PendingCounteredEffects` プロパティ + `CounterAction` 経路 2、詳細は [`counter-counter.md`](counter-counter.md))|
