...
| INF-136 | `PersistedSessionV1Tests.Given_AssociatedCardIdsフィールド欠落のJSON文字列_When_Deserialize後にToDomain_Then_空集合に復元される` | JSON 文字列経由の後方互換性(JSON フィールド欠落 → null → 空集合)|
