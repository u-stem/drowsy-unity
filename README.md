...
**Phase 1(Domain 拡張)完結** / **Phase 2 進行中** / **M1(ターン進行 + カードプレイの最小骨格)完成**(M1-PR1〜PR7 完了、N=2 のセットアップ + Draw → Play → EndTurn ループが動作、効果なし / 勝敗なし / UI なしの ADR-0005 §M1 Definition of Done 達成)

| 項目 | 値 |
| ---- | ---- |
| マージ済 PR | 27(M1-PR7 = #28 マージで 28) |
| NUnit テスト | 334 件全緑(Domain 205 / Application 129) |
| Domain C0 カバレッジ | 100%(全 9 クラス) |
| Application C0 カバレッジ | 100%(M1 完成時、Unity Code Coverage で計測) |
| EARS 要件 ID | 235(CARD 8 / CDATA 17 / HAND 22 / PILE 17 / PLAYER 18 / GS 22 / TURN 12 / RND 5 / CFG 4 / APP 29 / DZ 81) |
| ADR | 6(運用 / Phase 1 設計 / TODO 運用 / IsExternalInit polyfill / Phase 2 Roadmap / M1 詳細) |
