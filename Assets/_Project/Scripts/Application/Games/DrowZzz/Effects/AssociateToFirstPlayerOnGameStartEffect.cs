...
{
    /// <summary>
    /// 「ゲーム開始時、先行プレイヤーがこの手段を連想する」効果マーカー record(No.19「絶対障壁」で初導入)。
    /// </summary>
    /// <remarks>
    ...
    /// 追加され、<see cref="DrowZzzGameSession.AssociatedCardIds"/> にも記録される(連想由来記録と整合、
    ...
    /// </para>
    /// <para>
    /// 本 effect 持ちカードは <c>Bootstrap.BuildInitialDeck</c> の共通山札からも
