...
namespace Drowsy.Application.Games.DrowZzz.Effects
{
    ...
    /// illegal-move 化される(<see cref="AssociatableMarkerEffect"/> と同じマーカー方式)。
    /// </summary>
