namespace Drowsy.Application.Games.DrowZzz.Effects
{
    ...
    /// 影響保有者の <c>AbandonAction</c> 実行直後に発動する Reactive effect(ADR-0022 / No.12「偽りの太陽」、2026-05-17 で導入)。
    ...
    /// 本 AbandonAction で新規付与された影響は snapshot 外で対象外(ADR-0022 §4 snapshot ベース walk)。
    /// </para>
    /// <para>
