...
namespace Drowsy.Bootstrap
{
    ...
    public sealed class ProjectLifetimeScope : LifetimeScope
    {
        ...
        /// </summary>
        /// <remarks>
        /// catalog 登録カード(Phase 2 完結後 20 種:No.00 / No.01 / No.02 / No.03 / No.04 / No.05 / No.06 / No.07 / No.08 / No.09 / No.10 / No.11 / No.12 / No.13 / No.14 / No.15 / No.16 / No.17 / No.18 / No.19)を各
        ...
        /// (ADR-0024、先行プレイヤーの開始時自動連想のみが入手経路、後手は引けない)。
        /// N=2 × MaxRound 21 × 1 Draw = 42 + 初期配布 10 = 52 枚を賄える値。19 種(No.19 除外後)× 20 枚 = 380 枚で余裕 328 枚。
        ...
        /// No.04 / No.05 各 2 枚 2026-05-17、No.06 = 1 枚 2026-05-17、No.07 = 1 枚 / No.08 = 3 枚 2026-05-17、No.09 = 2 枚 2026-05-17、No.10 = 2 枚 2026-05-17、No.11 = 1 枚 2026-05-17、No.12 = 2 枚 2026-05-17、No.13 / No.14 / No.15 各 2 枚 2026-05-17、No.16 = 1 枚 2026-05-17、No.17 = 3 枚 2026-05-18、No.18 = 3 枚 2026-05-18、No.19 = 共通山札 0 枚 + 先行プレイヤー開始時連想 1 枚 2026-05-18)。
        /// <para>
        ...
        /// の本物デッキ実装で「`registered.Count × CopiesPerCardForM5Deck`」の機械導出形式に置き換える方針
        /// (Bootstrap 自体が Phase 3 で再実装されるため、本暫定実装の存続期間中は列挙形式を維持)。
        /// </para>
        /// </remarks>
        ...
        private static Pile BuildInitialDeck(ScriptableObjectCardCatalog catalog)
        {
            ...
            {
                // ADR-0024:`AssociateToFirstPlayerOnGameStartEffect` 持ちのカード(No.19「絶対障壁」等)は
        ...
        // ADR-0024 ヘルパー:Bootstrap.BuildInitialDeck の除外フィルタ用。
        // StartGameUseCase.HasFirstPlayerAssociationEffectInTopLevel と同じ判定ロジックだが、レイヤ境界を尊重して
        // Bootstrap 側にも複製(Bootstrap → Application 内部 helper への依存を作らない、ADR-0024 §3)。
