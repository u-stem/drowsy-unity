...
namespace Drowsy.Bootstrap
{
    ...
    public sealed class ProjectLifetimeScope : LifetimeScope
    {
        ...
        /// </summary>
        /// <remarks>
        /// catalog 登録カード(Phase 2 完結後 10 種:No.00 / No.01 / No.02 / No.03 / No.04 / No.05 / No.06 / No.07 / No.08 / No.09)を各
        /// <see cref="CopiesPerCardForM5Deck"/> 枚並べて <c>initialDeck</c> を組み立てる。
        /// N=2 × MaxRound 21 × 1 Draw = 42 + 初期配布 10 = 52 枚を賄える値。10 種 × 20 枚 = 200 枚で余裕 148 枚。
        ...
        /// No.04 / No.05 各 2 枚 2026-05-17、No.06 = 1 枚 2026-05-17、No.07 = 1 枚 / No.08 = 3 枚 2026-05-17、No.09 = 2 枚 2026-05-17)。
        /// <para>
