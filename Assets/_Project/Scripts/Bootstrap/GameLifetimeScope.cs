...
namespace Drowsy.Bootstrap
{
    ...
    /// <b>登録対象</b>:
    /// <list type="bullet">
    /// <item><see cref="StartGameUseCase"/> — Game Singleton
    ...
    /// (<c>RegisterComponentInNewPrefab</c> は Phase 3 のリトライ UI で再評価)</item>
    /// </list>
    /// </para>
    /// <para>
    /// <b>スコープ生成タイミング</b>:現在はアプリ起動直後 1 回限定(リスタート / リトライ UI なし)。
